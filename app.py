...
def generar_pdf():
    ...
    # Fecha de evaluación para PDF (la fecha que el usuario ingresó en el formulario)
    ...
    try:
        ...
        if form_type == 'neurologia':
            campos = {
                ...
                "fecha_evaluacion": fecha_evaluacion_from_db_formatted, # <-- AHORA USA LA FECHA DE EVALUACIÓN DEL FORMULARIO
