    ...
    try:
        ...
        if form_type == 'neurologia':
            ...
            campos = {
                ...
                "Nombres y Apellidos_Doctor": "", # Se llenará con la lógica de la doctora logueada o estático
                "Rut_Doctor": "",
...
def admin_cargar_nomina():
    ...
    if not all(k in col_map for k in required_columns_excel):
        missing_cols = [col for col in required_columns_excel if col not in col_map]
        print(f"ERROR: No se encontraron columnas críticas en el Excel: {missing_cols}. Columnas esperadas: {column_mappi
